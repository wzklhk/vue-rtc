<template>
  <div>
    <h1 style="margin: 10px; text-align: center">用户管理</h1>
    <div>
...
import {deleteById, deleteByIdInBatch, get, save, update} from "@/api/access/admin/user";
